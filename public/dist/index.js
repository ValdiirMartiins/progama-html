...
function weightFormula(gravity) {
...
function addPlanet(name, coordinates, situation, atmosphere, gravity) {
    planets.push({
        name,
        coordinates,
        situation,
...
function synchronizeSatellites(planet) {
...
function sixthMenuOption() {
    promptValidPlanet(planet => {
        synchronizeSatellites(planet).then((planetResult) => {
